...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--total_duration", type=int, default=600, help="total_duration"
    )
    parser.add_argument(
        "--interval",
        type=int,
    ...
    parser.add_argument("--inflateRate", type=float, default=0.5, help="inflate rate")

    parser.add_argument(
        "--ncolumns", type=int, default=10, help="fault 1 number of columns except id"
    )
    parser.add_argument("--nrows", type=int, default=10, help="fault 1 number of rows")
    parser.add_argument("--colsize", type=int, default=10, help="fault 1 column length")

    parser.add_argument("--tabsize", type=int, default=10, help="fault 2 table size")

    parser.add_argument("--bench", type=str, default="tpcc", help="benchmark name")
    parser.add_argument(
        "--benchconfig", type=str, default="0.txt", help="benchmark config"
    )

    parser.add_argument("--result", type=str, default="0.txt", help="result file name")
    ...
    if client_1 > 0:
        fault_1(table_name, client_1, interval, duration, ncolumns, nrows, colsize)
    ...
    if client_5 > 0:
        fault_5(table_name, client_5, interval, duration, ncolumns, nrows, colsize)
